...
- **Opinie z rejsu** dla każdego załoganta (szablon AKŻ AGH) – jedna strona A4; działa też bez dziennika (ręczne godziny, porty, dane jachtu), trasa ze śladu GPS lub własnego zdjęcia, zdjęcie załogi, logo rejsu i logo AKŻ, eksport PDF.
